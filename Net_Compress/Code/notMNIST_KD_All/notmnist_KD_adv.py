...
export_dir = 'notMNIST_Model_Student_KD_adv/'
...
model_name_save_student = 'notmnist_student_KD_adv'
...
with graph_student_KD.as_default():
  ...
  optimizer_student = tf.train.AdamOptimizer(learning_rate=0.0001).minimize(loss_student, var_list=student_parameters)
