...
with graph_student_KD.as_default():
  ...
  layer3_weights_teacher = tf.Variable(tf.truncated_normal([num_hidden_teacher, num_hidden_teacher], stddev=0.1), name='l3wt')
  ...
  # Hidden2 to Hidden3 Layer
  layer3_weights_student = tf.Variable(tf.truncated_normal([num_hidden_student, num_hidden_student], stddev=0.1), name='l3ws')
  layer3_biases_student = tf.Variable(tf.constant(1.0, shape=[num_hidden_student]), name='l3bs')
