...
export_dir = 'MNIST_Model_Student_KD_WGAN/'
...
model_name_save_student = 'mnist_student_KD_WGAN'
data_dir = 'MNIST_data/'
...
with graph_student_KD.as_default():
  ...
  D_solver = tf.train.RMSPropOptimizer(learning_rate=0.000002).minimize(loss_disc, var_list=disc_parameters)
